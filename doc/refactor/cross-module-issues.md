...
> 2026-07-17 阶段 0-5 修复落地后的条目状态索引，汇总见 `changes/2026-07-17-审计修复-阶段0-5汇总.md`。
> 下方正文条目保持审计当时的记录，未改动。

**已修复**：

- 🔴 HIGH：H-01、H-02、H-03、H-04、H-05、H-06、H-07、H-08（全部）
- 🟡 MEDIUM：M-01、M-02、M-03、M-04、M-05、M-06、M-07、M-11、M-12、M-15、M-16、M-19
- 🟡 MEDIUM（部分）：M-14——CJK Extension A 已纳入 token 估算 + `doc/technical.md` 补误差说明；换 DeepSeek tokenizer 违反零依赖原则，不做
- 🟢 LOW：L-02、L-03、L-04、L-05、L-06、L-07、L-08、L-09、L-10、L-11、L-12

**未修复**：

- M-09（`tools_were_called` 防护已在，残留部分为 LOW）、M-13、M-17、M-18、M-20、M-21、L-01

**无需修复（2026-07-17 验证降级）**：

- M-08、M-10——验证为审计误报/生产路径不可达，正文已降为 LOW；M-10 的空注册表死回退已随阶段 4 #273 一并删除
