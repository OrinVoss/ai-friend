...
> 最后更新：2026-06-01 | 总计 91 issues（49 已完成，42 开放）| 架构里程碑：三层 Agent (InnerDrive + ToolAgent + Roleplay) 已上线 | 语义搜索：Qwen3.5-0.8B 本地嵌入已上线 | #125 InnerDrive + 主动行为集成已上线 | #6 虚假记忆修正已上线
